				...
				<tbody>
					...
					<tr>
						...
						<td><div class="input-group col-md-offset-1">
								<input id="codein" type="text" class="form-control" placeholder="Enter verification code"> <span
									class="input-group-btn">
									<button id="codebtn" class="btn btn-default"
										data-bind="click: sendCode">Submit</button>
								</span>
							</div></td>
					</tr>
					<tr>
						...
						<td>
							<form class="form-inline" method="GET" action="download">
								<button id="download" type="submit"
									class="btn btn-lg btn-primary">Download the data</button>
									<img id="handimg" src="img/hand-left.png"/>
							</form>
						</td>
					</tr>
				</tbody>
